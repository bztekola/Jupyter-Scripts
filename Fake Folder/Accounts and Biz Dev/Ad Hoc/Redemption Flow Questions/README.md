This project looks at the breakdown of sales by country. This is originally for Codecademy. Some details can be found in the email with subject line "Re: Redemption Flow Questions (adding partnerships and jarad)", emailed to partnerships@adafruit.com. In the email, Codecademy wants to know the following things:
